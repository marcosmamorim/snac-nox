...
struct Flow {
    ...
    Flow() :
        ...
        nw_src(0), nw_dst(0),
        tp_src(0), tp_dst(0) { } // for Python bindings
    Flow(uint16_t in_port_, const Buffer&, bool invalid_=false);
    Flow(const ofp_match& match, bool invalid_=false);
    Flow(const ofp_match* match, bool invalid_=false);
