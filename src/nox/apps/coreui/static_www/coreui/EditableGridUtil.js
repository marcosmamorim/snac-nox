...
dojo.provide("nox.apps.coreui.coreui.EditableGridUtil");


dojo.declare("nox.apps.coreui.coreui.EditableGridUtil", [], {
...
(function () {
    ...
    nox.apps.coreui.coreui.getEditableGridUtil = function () {
        if (editable_grid_util == null) {
            editable_grid_util = new nox.apps.coreui.coreui.EditableGridUtil();
        }
