...
dojo.provide("nox.apps.coreui.coreui.ItemInspector");
...
dojo.declare("nox.apps.coreui.coreui.ItemInspector", [ dijit._Widget, dojox.dtl._Templated ], {

    templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/ItemInspector.html"),
	editIconPath: dojo.moduleUrl("nox.apps.coreui.coreui", "images/editIndicator.png"),
    ...
    _update_row: function (i) {
        ...
        if (m.separator == null || m.separator != true) {
            ...
            if (! nox.apps.coreui.coreui.base.equivDomTrees(old_v, new_v)) {
