...
dojo.provide("nox.apps.coreui.coreui.ItemList");

dojo.require("dijit._Widget");
dojo.require("dijit._Templated");
dojo.require("nox.apps.coreui.coreui._ItemSort");

dojo.require("dojox.dtl.Context");

dojo.declare("nox.apps.coreui.coreui.ItemList", [ dijit._Widget, dijit._Templated, nox.apps.coreui.coreui._ItemSort ], {
    templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/ItemList.html"),
	DTLTemplatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/ItemListDTL.html"),
	editableDTLTemplatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/EditableItemListDTL.html"),
	deleteIcon: dojo.moduleUrl("nox.apps.coreui.coreui", "images/itemClose.png"),
