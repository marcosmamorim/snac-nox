dojo.provide("nox.apps.coreui.coreui.ItemListEditor");
...
dojo.declare("nox.apps.coreui.coreui.ItemListEditor", dijit.Dialog, {
	templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/ItemListEditor.html"),
