...
dojo.provide("nox.apps.coreui.coreui.ItemTable");
...
dojo.declare("nox.apps.coreui.coreui.ItemTable", [ dijit._Widget, dijit._Templated, nox.apps.coreui.coreui._ItemSort ], {
    templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/ItemTable.html"),
    ...
    _onItemChange: function (item, attribute, oldValue, newValue) {
        ...
        for (var i = 0; i < this.model.length; i++) {
            ...
            if (! nox.apps.coreui.coreui.base.equivDomTrees(t, c.childNodes[0])) {
