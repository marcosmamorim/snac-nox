...
dojo.provide("nox.apps.coreui.coreui.ListTableHelper");
...
dojo.declare("nox.apps.coreui.coreui.ListTableHelper",[], {
  ...
  */  
  ...
  _fill_dir_boxes : function() {
    dojo.forEach(this.dir_boxes, function(db) { 
      ...
      var q = {}; 
      q[db.query] = true;
      nox.apps.directory.directorymanagerws.Directories.datastore.fetch({
          query : q, 
          onItem : function(x) {
