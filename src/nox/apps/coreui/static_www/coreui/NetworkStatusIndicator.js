dojo.provide("nox.apps.coreui.coreui.NetworkStatusIndicator");
...
dojo.declare("nox.apps.coreui.coreui.NetworkStatusTooltip", dijit.TooltipDialog, {
	templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/NetworkStatusTooltip.html"),
...
dojo.declare("nox.apps.coreui.coreui.NetworkStatusIndicator", [ dijit.layout.BorderContainer, dijit._Templated ], {
	templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/NetworkStatusIndicator.html"),
	...
	onNewStatus: function(item){
		...
		if(this.state.showNotifications && !this.state.expanded && item['status'] != 'normal'){
			if(!this.tooltip){
				this.tooltip = new nox.apps.coreui.coreui.NetworkStatusTooltip({
					title: "Network Status Changed",
					autofocus: false,
					parentWidget: this,
