dojo.provide("nox.apps.coreui.coreui.PrincipalGridFilter");
...
dojo.declare("nox.apps.coreui.coreui.PrincipalGridFilter", [dijit._Widget, dijit._Templated], {
	templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/PrincipalGridFilter.html"),
	widgetsInTemplate: true,

	grid: null,
	principalType: "switch",
	directoryStore: nox.apps.directory.directorymanagerws.Directories.datastore,

	constructor: function(){
		this._wconnects = []
		this.directoryStore = nox.apps.directory.directorymanagerws.Directories.datastore;
	},
