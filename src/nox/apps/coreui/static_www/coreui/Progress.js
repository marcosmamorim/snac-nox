dojo.provide("nox.apps.coreui.coreui.Progress");
...
dojo.requireLocalization("nox.apps.coreui.coreui", "Progress");

dojo.declare("nox.apps.coreui.coreui._Tooltip", dijit._MasterTooltip, {
	disabled: true,
	...
	postMixInProperties: function(){
		var _nlsResources = dojo.i18n.getLocalization("nox.apps.coreui.coreui", "Progress");
...
dojo.declare("nox.apps.coreui.coreui.ProgressTooltip", nox.apps.coreui.coreui._Tooltip, {
	templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/ProgressTooltip.html"),
...
dojo.declare("nox.apps.coreui.coreui.ErrorTooltip", nox.apps.coreui.coreui._Tooltip, {
	templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/ErrorTooltip.html"),
...
dojo.declare("nox.apps.coreui.coreui.Progress", [dijit._Widget, dijit._Templated], {
	loadingImage: dojo.moduleUrl("nox.apps.coreui.coreui", "images/progress.gif"),
	...
	postCreate: function(){
		...
		this.tooltip = new nox.apps.coreui.coreui.ProgressTooltip({
			connectId: [ this.domNode ],
			disabled: true
		});
		this.errorTooltip = new nox.apps.coreui.coreui.ErrorTooltip({
			id: "noxErrorTooltip",
			connectId: [ this.domNode ],
			disabled: true
		});
		...
		var u = nox.apps.coreui.coreui.getUpdateMgr();
		...
		this.connect(nox.apps.coreui.coreui.UpdateErrorHandler, "onError", "onError");
	},
    ...
    onRetry: function () {
		...
		this._error = false;
		this.onIdle();
		nox.apps.coreui.coreui.getUpdateMgr().retry_failed_request();
    },
    ...
    if(args.validation_error != null && args.validation_error == true) { 
      ...
      nox.apps.coreui.coreui.getUpdateMgr().suspend();
	...
	onDismissError: function(){
        ...
        nox.apps.coreui.coreui.getUpdateMgr().resume();
        this.resume_on_dismiss = false; 
    } else 
		  nox.apps.coreui.coreui.getUpdateMgr().skip_failed_request();
	},
