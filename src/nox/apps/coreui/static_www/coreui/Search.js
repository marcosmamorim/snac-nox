dojo.provide("nox.apps.coreui.coreui.Search");

dojo.require("dijit.Menu");
dojo.require("dijit.form.TextBox");
dojo.require("dijit.form.Button");

dojo.declare("nox.apps.coreui.coreui.Search", [dijit._Widget, dijit._Templated], {
    
    templatePath: dojo.moduleUrl("nox.apps.coreui.coreui", "templates/Search.html"),
