...
dojo.provide("nox.apps.coreui.coreui.UpdateErrorHandler");

dojo.require("nox.apps.coreui.coreui.base");

dojo.require("dojo.i18n");
dojo.requireLocalization("nox.apps.coreui.coreui", "UpdateErrors");
...
(function() {
    ...
    ueh.create = function (scope, customHandlers) {
        ...
        if (msgs == null)
            msgs = dojo.i18n.getLocalization("nox.apps.coreui.coreui", "UpdateErrors");
        var context = {
            scope: scope,
