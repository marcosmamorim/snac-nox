...
dojo.provide("nox.apps.coreui.coreui.UpdateMgr")
dojo.require("nox.apps.coreui.coreui.UpdateErrorHandler");

var corui = nox.apps.coreui.coreui; 

dojo.declare("nox.apps.coreui.coreui.UpdateMgr", [], {
...
(function () {
    var updatemgr = null;
    nox.apps.coreui.coreui.getUpdateMgr = function () {
        if (updatemgr == null) {
            updatemgr = new nox.apps.coreui.coreui.UpdateMgr();
        }
        return updatemgr;
    }
})();
