...
dojo.provide("nox.apps.coreui.coreui._UpdatingStore");
...
dojo.declare("nox.apps.coreui.coreui._UpdatingStore", [ ], {
    ...
    constructor: function (kwarg) {
        ...
        //     Must be a subclass of nox.apps.coreui.coreui._UpdatingItem;
        ...
        this.itemConstructor = nox.apps.coreui.coreui._UpdatingItem;
        this.itemParameters = {};
    ...
    update: function (kwarg) {
        ...
        //     nox.apps.coreui.coreui.UpdateErrorHandler.create().
...
dojo.extend(nox.apps.coreui.coreui._UpdatingStore,dojo.data.util.simpleFetch);
