dojo.provide("nox.apps.coreui.coreui.simple_config"); 
...
dojo.declare("nox.apps.coreui.coreui.simple_config", [], {
  ...
  submit_config : function(section_id, values,on_load) { 
    ...
    nox.apps.coreui.coreui.getUpdateMgr().rawXhrPut(put_obj); 
  }, 
...
(function () {
    ...
    nox.apps.coreui.coreui.getSimpleConfig = function () {
        if (simple_config == null) {
            simple_config = new nox.apps.coreui.coreui.simple_config();
        }
