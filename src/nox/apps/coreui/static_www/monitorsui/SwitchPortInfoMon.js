...
dojo.provide("nox.apps.coreui.monitorsui.SwitchPortInfoMon");
...
dojo.require("nox.apps.coreui.monitorsui.SwitchPortNatConfig"); 

var netevents = nox.apps.user_event_log.networkevents;
var dmws = nox.apps.directory.directorymanagerws;
var coreui = nox.apps.coreui.coreui;
var monitorsui = nox.apps.coreui.monitorsui;
        ...
        model: [
            {name: "location-name", header: "Location Name", 
             ...
             editSet: function (item, value) {
                 var loc = new nox.apps.directory.directorymanagerws.Location({
                     initialData: { name: item.getValue("location") }
                 });
                 if(!loc.isNull()){
                     loc.rename({
