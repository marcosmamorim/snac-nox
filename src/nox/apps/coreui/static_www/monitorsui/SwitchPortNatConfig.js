dojo.provide("nox.apps.coreui.monitorsui.SwitchPortNatConfig");
...
dojo.declare("nox.apps.coreui.monitorsui.SwitchPortNatConfig", [ dijit._Widget, dijit._Templated ], {
    templatePath: dojo.moduleUrl("nox.apps.coreui.monitorsui", 
  ...
  _generate_policy_text: function() {
    ...
    startup: function () {
        ...
        this.simple_config = nox.apps.coreui.coreui.getSimpleConfig();
