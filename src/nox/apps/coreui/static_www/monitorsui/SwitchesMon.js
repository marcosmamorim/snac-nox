...
dojo.provide("nox.apps.coreui.monitorsui.SwitchesMon");
...
dojo.require("nox.apps.coreui.coreui.PrincipalGridFilter");
...
function handle_updates(component) {
    if (component == "nox.apps.directory.directorymanagerws.Directories") {
