...
<%def name="dojo_imports()">
  ...
  @import "/static/nox/apps/coreui/coreui/base.css";
</%def>
<%def name="dojo_requires()">
  dojo.require("dojo.parser");
  dojo.require("dijit.dijit");
  dojo.require("nox.apps.coreui.coreui.noxcore");
</%def>
...
<!--
  <script type="text/javascript" src="/static/nox/apps/coreui/coreui/_UpdatingStore.js"></script>
--> 
