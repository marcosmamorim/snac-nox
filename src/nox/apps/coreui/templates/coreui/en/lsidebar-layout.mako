...
<%def name="head_js()">
  ...
  dojo.addOnLoad(function () {
      nox.apps.coreui.coreui.base.highlight_current_sidebar_link();
      footerData = new nox.ext.apps.snackui.snackmonitors.NetworkOverviewData({
          updateList: [ "serverstat" ]
      });
      nox.apps.coreui.coreui.getUpdateMgr().userFnCall({
...
<div dojoType="dijit.layout.ContentPane" region="left" id="lsidebar">
    <div dojoType="dijit.layout.BorderContainer">
        <div dojoType="dijit.layout.ContentPane" region="center">
           <form dojoType="nox.apps.coreui.coreui.Search" id="searchBox">
        ...
        ## should be removed.
		<!-- <div id="networkStatusContainer" dojoType="nox.apps.coreui.coreui.NetworkStatusIndicator" region="bottom"></div> -->
    </div>
</div>
    ...
    <div dojoType="dijit.layout.BorderContainer" design="headline">
        <div dojoType="dijit.layout.ContentPane" id="module_header" region="top">
            <div id ="module-titlebar">
                ...
                <div jsid="progress" id="progress" dojoType="nox.apps.coreui.coreui.Progress"></div>
            </div>
            ${self.module_header()}
        </div>
